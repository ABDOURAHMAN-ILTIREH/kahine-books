...
import {MdOutlineDriveFolderUpload, MdOutlineUpdate } from 'react-icons/md'
  ...
  return (
    <div className='Update_Product'>
        <div className="top_content">
           <h1>update the books content</h1>
           <p>Update the product to add new features</p>
         </div>
        ...
        <h2>completly fill the form below</h2>
            <form>
                ...
                <div className="input_row">
                    ...
                    <div className="input_from">
                        <button><MdOutlineUpdate className="icons"/>Submit The Updates</button>
                    </div>
                </div>
            </form>
        </div>
